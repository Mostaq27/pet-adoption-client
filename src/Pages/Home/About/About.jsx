            ...
            <div className='mx-10'>
                <section className=" py-8">
                    <div className="container mx-auto px-2 pt-4 pb-12">
                        <h1 className="w-full my-2 text-5xl font-bold leading-tight text-center text-[#00aaff]">About Us</h1>
                        ...
                        <div className="flex flex-col md:flex-row justify-center pt-12 my-12 sm:my-4">
                            <div className="md:w-1/2 pr-4 ">
                                <h3 className="text-2xl mb-2 font-bold text-[#00aaff]">How The Website
                                    works</h3>
                                ...
                                <h3 className="text-2xl mb-2 font-bold text-[#00aaff]">Why We Created This Website</h3>
